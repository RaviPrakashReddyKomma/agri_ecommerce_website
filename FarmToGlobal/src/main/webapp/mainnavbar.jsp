...
<nav class="navbar">
    ...
    <ul class="navbar-links" style="list-style: none; padding: 0; margin: 0; display: flex;">
        ...
        <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Registration <span class="caret"></span></a>
            <ul class="dropdown-menu">
                <li><a href="/customerreg">Customer Registration</a></li>
                <li><a href="/farmerreg">Farmer Registration</a></li>
            </ul>
        </li>
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="/farmerlogin">Farmer Login</a></li>
